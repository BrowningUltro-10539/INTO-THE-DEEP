...
public class MeepMeepTesting {
    public static void main(String[] args) {
        ...
        RoadRunnerBotEntity myBot = new DefaultBotBuilder(meepMeep)
                ...
                .followTrajectorySequence(drive -> drive.trajectorySequenceBuilder(new Pose2d(-26, -65, Math.PI/2))
                        .strafeRight(26)
                        .forward(32)
                        .waitSeconds(0.5)
                        .forward(-6)
                        ...
                        .waitSeconds(0.5)
                        .turn(Math.PI)
                        .splineTo(new Vector2d(0, -33), Math.PI  / 2)
                        .waitSeconds(0.5)
                        .lineTo(new Vector2d(46.7, -59.2))
                        .turn(Math.PI)
                        .waitSeconds(0.5)
                        .turn(Math.PI)
                        .splineTo(new Vector2d(0, -33), Math.PI  / 2)
