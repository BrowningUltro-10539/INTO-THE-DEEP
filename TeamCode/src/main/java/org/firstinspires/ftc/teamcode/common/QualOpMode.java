...
@TeleOp
public class QualOpMode extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            ...
            if(gamepad1.dpad_up){
                CommandScheduler.getInstance().schedule(new LiftPositionCommand(robot.h_lift, 20));
            }

            if(gamepad1.dpad_down){
                CommandScheduler.getInstance().schedule(new LiftPositionCommand(robot.h_lift, -2));
            }
            ...
            if(gamepad2.y){
                CommandScheduler.getInstance().schedule(new InstantCommand(() -> robot.outtake.setClaw()));
            }
